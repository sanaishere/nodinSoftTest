...
export class UserService {
   ...
   async uploadProfile(fileName:string,user:User) {
   ...
   async editMyProfile(editProfileInput:EditProfileDto,user:User) {
    ...
    try{
      ...
      return `your ${editProfileInput} are updated successfully`
    }catch(error) {
   ...
   async getAllUsers() {
    const queryResult= await this.dataBaseService.runQuery('SELECT * FROM user',null)
